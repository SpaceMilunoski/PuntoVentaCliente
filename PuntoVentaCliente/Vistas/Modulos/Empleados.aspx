                ...
                <div class="col-sm-6" style="background-color: white;">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <asp:TextBox ID="txtbPuesto" runat="server" type="text" class="form-control" name="Puestos" placeholder="Introduzca el puesto" MaxLength="50" TextMode="SingleLine" AutoCompleteType="Disabled" visible="false"></asp:TextBox>

                            <br />

                            <asp:Button ID="btnAgregarPuesto" runat="server" Text="Nuevo Puesto" class="btn btn-primary" center-align="true" OnClick="btnAgregarPuesto_Click" />
                            <asp:Button ID="btnEliminarPuesto" runat="server" Text="Eliminar Puesto" class="btn btn-danger" center-align="true" OnClick="btnEliminarPuesto_Click" />
